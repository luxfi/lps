...
# New LIP Creation Script
# Helps authors create a new LIP with proper formatting
...
echo -e "${GREEN}Welcome to the LIP Creation Wizard!${NC}"
echo "==================================="
echo
...
# Create the file
filename="LIPs/lip-draft.md"

print_info "Creating new LIP draft at $filename"

# Generate the LIP content
cat > "$filename" << EOF
---
lip: <to be assigned>
title: $title
...
[TODO: Explain why this LIP is needed. What problem does it solve? Why should someone want to implement this standard? What benefit does it provide to the Lux ecosystem? What use cases does this LIP address?]
...
[TODO: Flesh out the specification by describing what motivated the design and why particular design decisions were made. Describe alternate designs that were considered and related work. The rationale should discuss important objections or concerns raised during discussion around the LIP.]

## Backwards Compatibility

[TODO: Describe any backwards incompatibilities and their consequences. The LIP must explain how the author proposes to deal with these incompatibilities. LIP submissions without a sufficient backwards compatibility treatise may be rejected outright.]
...
[TODO: Provide test cases for an implementation. Tests should either be inlined in the LIP as data (such as input/expected output pairs, or included in `../assets/lip-###/<filename>`.]
...
print_success "LIP draft created successfully!"
echo
...
echo "https://github.com/luxfi/lips/discussions/new"